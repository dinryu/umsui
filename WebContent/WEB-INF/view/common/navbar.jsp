...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a id="navbar" onclick="moveTo('common','index')"><span class="glyphicon glyphicon-home"></span>&nbsp;Home</a></li>
    ...
    <span class="float-right" style="color: green;">${sessionScope.user.name} &nbsp; <a id="logout" >| 로그아웃</a></span>
  </div>
</nav>
<script>
